...
import com.example.musicappui.Browse
...
import com.example.musicappui.Subcription as Subcription
...
fun MainView(){
    ...
    //allow Us to find out which   "view" we current in
...
fun MoreBottomSheet(modifier : Modifier){
    Box(
        Modifier
            .fillMaxWidth().height(300.dp).background(
